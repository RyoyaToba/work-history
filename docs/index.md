...
- **バックエンドエンジニア(４年)**  
  Kotlinを用いたバックオフィス系SaaS開発、Goを用いたヘルスケア領域のモバイルアプリ向けAPI開発、Javaを用いた勤怠システムの機能追加・保守を担当。
...
### 株式会社ラクスパートナーズ（2022年4月～2025年9月）

<div style="margin-top: 1.5em"></div>

- **ヘルスケアモバイルアプリ開発・保守（2024年10月～2025年9月）**

  ユーザーの健康管理を支援するモバイルアプリの改善開発を担当。
